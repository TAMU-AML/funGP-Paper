%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   DESCRIPTION:
%   main function for funGP truncation number experiment for Type 1 error for GP sample function 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function[] = TruncNumberExperiment_gpSample_Type1(trunc_number)
    
    logfile = strcat('TruncNumber_',num2str(trunc_number),'_gpSample_Type1.log');
    ...
    fprintf('Truncation number experiment for Type 1 error using gpSample function\n');

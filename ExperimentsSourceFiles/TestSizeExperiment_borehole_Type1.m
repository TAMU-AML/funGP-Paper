%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   DESCRIPTION:
%   main function for funGP test size experiment simulation for Type 1 error for borehole function 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function[] = TestSizeExperiment_borehole_Type1(ntest)
   
    logfile = strcat('TestSize_',num2str(ntest),'_borehole_Type1.log');
    ...
    fprintf('Test size experiment for Type 1 error using borehole function\n')

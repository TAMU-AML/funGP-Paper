%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   DESCRIPTION:
%   main function for funGP test size experiment simulation for Type 2 error for gpSample function 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function[] = TestSizeExperiment_gpSample_Type2(ntest)
    
    ntrain = 500; %number of training samples
    logfile = strcat('TestSize_',num2str(ntest),'_gpSample_Type2.log');
    ...
    fprintf('Test size experiment for Type 2 error using gpSample function\n')

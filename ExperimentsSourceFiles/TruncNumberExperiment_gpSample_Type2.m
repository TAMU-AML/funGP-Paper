%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   DESCRIPTION:
%   main function for funGP truncation number experiment simulation for Type 2 error using gp sample  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function[] = TruncNumberExperiment_gpSample_Type2(trunc_number)
    
    ntrain = 500; %number of training samples
    logfile = strcat('TruncNumber_',num2str(trunc_number),'_gpSample_Type2.log');
    ...
    fprintf('Truncation number experiment for Type 2 error using gpSample function\n')

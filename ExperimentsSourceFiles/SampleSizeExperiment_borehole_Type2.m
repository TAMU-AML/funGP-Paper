%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   DESCRIPTION:
%   main function for funGP sample size experiment simulation for Type 2 error for borehole function 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function[] = SampleSizeExperiment_borehole_Type2(ntrain)
    
    logfile = strcat('SampleSize_',num2str(ntrain),'_borehole_Type2.log');
    ...
    fprintf('Sample size experiment for Type 2 error using borehole function\n')

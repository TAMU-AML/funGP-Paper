...
%   DESCRIPTION:
%   main function for funGP truncation number experiment simulation for Type 2 error for piston function 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function[] = TruncNumberExperiment_piston_Type2(trunc_number)
    
    logfile = strcat('TruncNumber_',num2str(trunc_number),'_piston_Type2.log');
    ...
    fprintf('Truncation number experiment for Type 2 error using piston function\n');

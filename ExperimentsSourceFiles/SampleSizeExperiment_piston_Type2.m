%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   DESCRIPTION:
%   main function for funGP sample size experiment simulation for Type 2 error for piston function 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function[] = SampleSizeExperiment_piston_Type2(ntrain)
    
    logfile = strcat('SampleSize_',num2str(ntrain),'_piston_Type2.log');
    ...
    fprintf('Sample size experiment for Type 2 error using piston function\n');

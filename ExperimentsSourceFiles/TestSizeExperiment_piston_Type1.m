%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   DESCRIPTION:
%   main function for funGP test size experiment simulation for Type 1 error for piston function 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function[] = TestSizeExperiment_piston_Type1(ntest)
    
    logfile = strcat('TestSize_',num2str(ntest),'_piston_Type1.log');
    ...
    fprintf('Test size experiment for Type 1 error using piston function\n')

...
function[] = SampleSizeExperiment_gpSample_Type2(ntrain)
   
    logfile = strcat('SampleSize_',num2str(ntrain),'_gpSample_Type2.log');
    ...
    fprintf('Sample size experiment for Type 2 error using gpSample function\n')

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   DESCRIPTION:
%   main function for Cox & Lee (2008) simulation for Type 2 error for piston function 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

n_simulation = 1000; %number of simualtions
n_type2 = 0 ; %variable to store the number of simulations with type 2 error for CL
n_type2_funGP = 0; %variable to store the number of simulations with type 2 error for funGP
confLevel = 0.95; %significance level

logfile = "CL_piston_Type2.log";
logID = fopen(logfile,'w');

fprintf('Cox and Lee experiment for Type 2 error using piston function\n')
...
while j <= n_simulation
    ...
    for nrows = 1:length_X
        ...
        Y2_noisy(nrows,:) = piston([M,S,X(nrows,1),kmod,P0,Ta,X(nrows,2)])+ normrnd(0,0.05,1,n_replications);   
    end

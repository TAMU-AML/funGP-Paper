%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   DESCRIPTION:
%   main function for funGP truncation number experiment simulation for Type 1 error for piston function 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function[] = TruncNumberExperiment_piston_Type1(trunc_number)
    
    logfile = strcat('TruncNumber_',num2str(trunc_number),'_piston_Type1.log');
    ...
    fprintf('Truncation number experiment for Type 1 error using piston function\n')

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   DESCRIPTION:
%   main function for funGP test size experiment simulation for Type 1 error using gp sample  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function[] = TestSizeExperiment_gpSample_Type1(ntest)
    
    logfile = strcat('TestSize_',num2str(ntest),'_gpSample_Type1.log');
    ...
    fprintf('Test size experiment for Type 1 error using gpSample function\n');

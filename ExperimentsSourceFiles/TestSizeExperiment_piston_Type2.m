%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   DESCRIPTION:
%   main function for funGP testset size experiment simulation for Type 2 error for piston function 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function[] = TestSizeExperiment_piston_Type2(ntest)
    
    logfile = strcat('TestSize_',num2str(ntest),'_piston_Type2.log');
    ...
    fprintf('Test size experiment for Type 2 error using piston function\n');

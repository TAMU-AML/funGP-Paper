%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   DESCRIPTION:
%   main function for Munk & Dette (1998) simulation for Type 2 error using gp sample 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Munk and Dette experiment for Type 2 error using gpSample function\n')
fprintf('Size of train data: %d\n', ntrain);
fprintf('Nominal level of the test: %.7f\n', confLevel);
fprintf("Number of simulations: %d\n",n_simulation);

logfile = "MD_gpSample_Type2.log";
...
fprintf('Expected power of test: %.3f\n',MDTest_Power(l2dist^2,confLevel,sigma_n^2,sigma_n^2,ntrain,ntrain));
fprintf('L2 distance between the functions: %.3f\n',l2dist);

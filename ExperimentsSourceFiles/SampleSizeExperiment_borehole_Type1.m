%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   DESCRIPTION:
%   main function for funGP sample size experiment simulation for Type 1 error for borehole function 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function[] = SampleSizeExperiment_borehole_Type1(ntrain)

    logfile = strcat('SampleSize_',num2str(ntrain),'_borehole_Type1.log');
    ...
    fprintf('Sample size experiment for Type 1 error using borehole function\n')
